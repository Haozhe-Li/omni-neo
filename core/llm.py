...
gpt_oss_120b_low = ChatGroq(model="openai/gpt-oss-120b", temperature=0.2).bind(reasoning_effort="low")
gpt_oss_120b_high = ChatGroq(model="openai/gpt-oss-120b", temperature=0.2).bind(reasoning_effort="high")
